...
No.382 LinkedListRandomNode
 ...
 common.ListNode head = new common.ListNode(1);
 head.next = new common.ListNode(2);
 head.next.next = new common.ListNode(3);
...
//    @author : hot13399
    ...
    When we read the first node head, if the stream common.ListNode stops here, we can just return the head.val. The possibility is 1/1.
    ...
    We can continue to do like this until the end of stream common.ListNode.
     */
//    common.ListNode head;
//    Random random;
//
//    public Solution(common.ListNode h) {
//        head = h;
//        random = new Random();
//    }
//
